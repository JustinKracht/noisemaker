...
# Model Error {.tabset .tabset-fade .tabset-pills}
...
## Specifying a Model {.tabset .tabset-fade .tabset-pills}
...
## The Tucker, Koopman, and Linn (TKL) Method {.tabset .tabset-fade .tabset-pills}
...
# The Cudeck and Browne (CB) Method {.tabset .tabset-fade .tabset-pills}
...
[^cb-caveat]: The same is also true when using ordinary least squares if the CB method is altered somewhat; see @cudeck1992 for details.

# The Wu and Browne (WB) Method {.tabset .tabset-fade .tabset-pills}
