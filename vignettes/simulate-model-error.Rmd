...
$$
\noindent where $\mathfb{E}$ is a non-null error matrix.
...
where $m > p - 1$ is a user-specified precision parameter. There is a useful relationship between $m$ and RMSEA such that $1/m = \varepsilon^2 + o(\varepsilon^2)$
